  ...
  return (
    <header className="">
      ...
      <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-motdark-700 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <LiaDoorClosedSolid className="h-6 w-6" aria-hidden="true" />
            </button>
          </div>
              ...
              <div className="space-y-2 py-6">
                {mobileNavigation.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-pink-100"
                  >
                    {item.name}
                  </a>
                ))}
